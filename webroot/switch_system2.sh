...
echo "--------------------------------------"
    ...
    "$PARTED" -s /dev/block/sde name 8 vbmeta_1
    "$PARTED" -s /dev/block/sde name 45 boot_1
    "$PARTED" -s /dev/block/sde name 47 vendor_1
    "$PARTED" -s /dev/block/sde name 48 system_1
    "$PARTED" -s /dev/block/sda name 18 cust_1
    "$PARTED" -s /dev/block/sda name 21 userdata_1
    "$PARTED" -s /dev/block/sda name 22 Extended
    "$PARTED" -s /dev/block/sda name 23 vbmeta
    "$PARTED" -s /dev/block/sda name 24 vendor
    "$PARTED" -s /dev/block/sda name 25 system
    "$PARTED" -s /dev/block/sda name 26 cust
    "$PARTED" -s /dev/block/sda name 27 userdata
    "$PARTED" -s /dev/block/sda name 28 boot
